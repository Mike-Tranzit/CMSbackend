...
class Plates
{
    public static function toBase($arg){ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($arg), true)) !== __AM_CONTINUE__) return $__am_res; 
        $arg=strtoupper($arg);
        $arg=str_replace (' ','',$arg);
    ...
    public static function fromBase($arg){ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($arg), true)) !== __AM_CONTINUE__) return $__am_res; 
